...
| **`v2.7.0 – v2.7.4`** | **`v2.5.1 – v2.6.0`** | 🔵 **Stable ↔ Stable** | ⭐️ **Full (100%)** | • Core Local Wi-Fi Pairing & Ping<br>• Complete Inventory Caching & Summary views<br>• Range Sessions, Outbox Sync & Bill of Sale exports<br>• Offline Cache Mode |
