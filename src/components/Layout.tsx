...
import { Ammo, CustomSkuDatabase, CustomSkuItem } from '../types';
    ...
    <div className="app-layout">
      ...
      <header className="app-topbar">
        ...
        <nav className="topbar-nav">
          ...
          <button
            className={`topbar-nav-link ${isActive('/bound-book')}`}
            onClick={() => navigate('/bound-book')}
          >
            <BookOpen size={16} />
            <span>Bound Book</span>
          </button>
          <button
            className={`topbar-nav-link ${isActive('/ammo') || isActive('/components')}`}
          ...
          <button
            className={`topbar-nav-link ${isActive('/accessories')}`}
          ...
          <button
            className={`topbar-nav-link ${isActive('/maintenance')}`}
            ...
            >
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
                ...
                >
                  ...
                  >
                    Generate comprehensive documentation of your firearms and accessories for
                    insurance or recordkeeping.
                  </p>
                  <div
                    style={{
                      display: 'grid',
                      ...
                      onClick={async () => {
                        if (window.api && window.api.generateInsuranceReport) {
                          try {
                            ...
                            const totalValue =
                              firearms.reduce(
                                (sum, f) => sum + (Number(f.purchase_price) || 0),
                                0
                              ) +
                              accessories.reduce(
                                (sum, a) =>
      ...
      {isSkuManagerOpen &&
        createPortal(
          <div
            ...
            onClick={() => setIsSkuManagerOpen(false)}
            style={{ zIndex: 100100 }}
          >
            <div
              className="modal"
              ...
              >
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                  ...
                  <div>
                    ...
                    >
                      Map manufacturer part numbers & custom SKUs for Ammunition, Parts/Accessories,
                      and Reloading Supplies for instant scanning.
                    </p>
                  </div>
                </div>
                <button
                    ...
                    >
                      ...
                      <div className="form-group" style={{ marginBottom: 0 }}>
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            setNewSkuData({ ...newSkuData, manufacturer: e.target.value })
                          }
                        />
                      </div>
                      <div className="form-group" style={{ marginBottom: 0 }}>
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            setNewSkuData({ ...newSkuData, caliber: e.target.value })
                          }
                        />
                      </div>
                      <div className="form-group" style={{ marginBottom: 0 }}>
                      ...
                      <div className="form-group" style={{ marginBottom: 0 }}>
                        ...
                        <div style={{ display: 'flex', gap: '0.5rem', alignItems: 'center' }}>
                          <input
                            ...
                            onChange={(e) =>
                              setNewSkuData({ ...newSkuData, projectile: e.target.value })
                            }
                          />
                          <label
                            style={{
                    ...
                    >
                      ...
                      <div className="form-group" style={{ marginBottom: 0 }}>
                        ...
                        <input
                          ...
                          value={
                            newSkuBoxPrice || (newSkuData.value ? String(newSkuData.value) : '')
                          }
                          onChange={(e) => setNewSkuBoxPrice(e.target.value)}
                        />
                      </div>
                      ...
                      return (
                        <button
                          ...
                          style={{
                            ...
                            cursor: 'pointer',
                            background:
                              skuFilter === tab ? 'rgba(255,255,255,0.15)' : 'transparent',
                            ...
                            <button
                              onClick={() => {
                                ...
                                if (cat === 'ammo') {
                                  ...
                                  setNewSkuBoxPrice(
                                    data.cost !== undefined ? String(data.cost) : ''
                                  );
                                }
                              }}
                              className="btn-icon"
