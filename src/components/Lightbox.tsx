    ...
    <div style={{
      ...
      <button 
        ...
        style={{
          ...
          background: 'transparent', border: 'none', color: 'white', cursor: 'pointer', zIndex: 10000
        }}
      >
        <X size={32} />
      </button>
      ...
      {images.length > 1 && (
        <button 
          ...
          style={{
            ...
            background: 'rgba(255,255,255,0.1)', border: 'none', color: 'white', borderRadius: '50%', padding: '10px', cursor: 'pointer'
          }}
        >
          <ChevronLeft size={32} />
        </button>
