import { AlertTriangle, Eye, EyeOff, Key, KeyRound, Lock, Shield } from 'lucide-react';
  ...
  if (recoveryCode) {
    return (
      ...
      >
        ...
        >
          Your Vault has been successfully encrypted with military-grade AES-256-GCM. If you ever
          forget your password, your data is mathematically unrecoverable unless you have this code.
      ...
      >
        <Shield
          ...
          style={{
            color: 'var(--accent)',
            marginBottom: '1.5rem',
            filter: 'drop-shadow(0 0 14px var(--accent-border, rgba(59,130,246,0.3)))',
          }}
        />
        ...
        <p style={{ color: 'var(--text-secondary)', marginBottom: '2rem' }}>
          {!isSetup
            ...
            : useRecovery
              ? 'Enter your 64-character recovery code.'
        ...
        >
          ...
          <button
            type="submit"
            className="btn-primary"
            style={{ marginTop: '0.5rem', padding: '0.8rem', fontSize: '1.1rem' }}
          >
