...
const outputDir = path.join(rootDir, 'dist-electron', 'stable');

if (!fs.existsSync(outputDir)) {
  fs.mkdirSync(outputDir, { recursive: true });
}

console.log('🚀 Building ArmoryVault (STABLE CHANNEL)...');
console.log(`📦 Output directory: dist-electron/stable\n`);
...
const fullArgs = [
  ...args,
  '-c.directories.output=dist-electron/stable'
];
