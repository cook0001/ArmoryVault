...
const outputDir = path.join(rootDir, 'dist-electron', 'release');

if (!fs.existsSync(outputDir)) {
  fs.mkdirSync(outputDir, { recursive: true });
}

console.log('🚀 Building ArmoryVault (OFFICIAL RELEASE)...');
console.log(`📦 Output directory: dist-electron/release\n`);
...
const fullArgs = [...args, '-c.directories.output=dist-electron/release'];
